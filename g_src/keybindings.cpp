...
bimap<DFKeySym,std::string> symNames;
...
void keybinding_init() {
  ...
  symNames.insert(DFKS_BACKSPACE, "Backspace");
  symNames.insert(DFKS_TAB, "Tab");
  symNames.insert(DFKS_CLEAR, "Clear");
  symNames.insert(DFKS_RETURN, "Enter");
  symNames.insert(DFKS_PAUSE, "Pause");
  symNames.insert(DFKS_ESCAPE, "ESC");
  symNames.insert(DFKS_SPACE, "Space");
  symNames.insert(DFKS_EXCLAIM, "Exclaim");
  symNames.insert(DFKS_QUOTEDBL, "Quotedbl");
  symNames.insert(DFKS_HASH, "Hash");
  symNames.insert(DFKS_DOLLAR, "Dollar");
  symNames.insert(DFKS_AMPERSAND, "Ampersand");
  symNames.insert(DFKS_QUOTE, "Quote");
  symNames.insert(DFKS_LEFTPAREN, "Leftparen");
  symNames.insert(DFKS_RIGHTPAREN, "Rightparen");
  symNames.insert(DFKS_ASTERISK, "Asterisk");
  symNames.insert(DFKS_PLUS, "Plus");
  symNames.insert(DFKS_COMMA, "Comma");
  symNames.insert(DFKS_MINUS, "Minus");
  symNames.insert(DFKS_PERIOD, "Period");
  symNames.insert(DFKS_SLASH, "Slash");
  symNames.insert(DFKS_0, "0");
  symNames.insert(DFKS_1, "1");
  symNames.insert(DFKS_2, "2");
  symNames.insert(DFKS_3, "3");
  symNames.insert(DFKS_4, "4");
  symNames.insert(DFKS_5, "5");
  symNames.insert(DFKS_6, "6");
  symNames.insert(DFKS_7, "7");
  symNames.insert(DFKS_8, "8");
  symNames.insert(DFKS_9, "9");
  symNames.insert(DFKS_COLON, "Colon");
  symNames.insert(DFKS_SEMICOLON, "Semicolon");
  symNames.insert(DFKS_LESS, "Less");
  symNames.insert(DFKS_EQUALS, "Equals");
  symNames.insert(DFKS_GREATER, "Greater");
  symNames.insert(DFKS_QUESTION, "Question");
  symNames.insert(DFKS_AT, "At");
  symNames.insert(DFKS_LEFTBRACKET, "Leftbracket");
  symNames.insert(DFKS_BACKSLASH, "Backslash");
  symNames.insert(DFKS_RIGHTBRACKET, "Rightbracket");
  symNames.insert(DFKS_CARET, "Caret");
  symNames.insert(DFKS_UNDERSCORE, "Underscore");
  symNames.insert(DFKS_BACKQUOTE, "Backquote");
  symNames.insert(DFKS_a, "a");
  symNames.insert(DFKS_b, "b");
  symNames.insert(DFKS_c, "c");
  symNames.insert(DFKS_d, "d");
  symNames.insert(DFKS_e, "e");
  symNames.insert(DFKS_f, "f");
  symNames.insert(DFKS_g, "g");
  symNames.insert(DFKS_h, "h");
  symNames.insert(DFKS_i, "i");
  symNames.insert(DFKS_j, "j");
  symNames.insert(DFKS_k, "k");
  symNames.insert(DFKS_l, "l");
  symNames.insert(DFKS_m, "m");
  symNames.insert(DFKS_n, "n");
  symNames.insert(DFKS_o, "o");
  symNames.insert(DFKS_p, "p");
  symNames.insert(DFKS_q, "q");
  symNames.insert(DFKS_r, "r");
  symNames.insert(DFKS_s, "s");
  symNames.insert(DFKS_t, "t");
  symNames.insert(DFKS_u, "u");
  symNames.insert(DFKS_v, "v");
  symNames.insert(DFKS_w, "w");
  symNames.insert(DFKS_x, "x");
  symNames.insert(DFKS_y, "y");
  symNames.insert(DFKS_z, "z");
  symNames.insert(DFKS_DELETE, "Delete");
  symNames.insert(DFKS_KP_0, "Numpad 0");
  symNames.insert(DFKS_KP_1, "Numpad 1");
  symNames.insert(DFKS_KP_2, "Numpad 2");
  symNames.insert(DFKS_KP_3, "Numpad 3");
  symNames.insert(DFKS_KP_4, "Numpad 4");
  symNames.insert(DFKS_KP_5, "Numpad 5");
  symNames.insert(DFKS_KP_6, "Numpad 6");
  symNames.insert(DFKS_KP_7, "Numpad 7");
  symNames.insert(DFKS_KP_8, "Numpad 8");
  symNames.insert(DFKS_KP_9, "Numpad 9");
  symNames.insert(DFKS_KP_PERIOD, "Numpad Period");
  symNames.insert(DFKS_KP_DIVIDE, "Numpad Divide");
  symNames.insert(DFKS_KP_MULTIPLY, "Numpad Multiply");
  symNames.insert(DFKS_KP_PLUS, "Numpad Plus");
  symNames.insert(DFKS_KP_MINUS, "Numpad Minus");
  symNames.insert(DFKS_KP_ENTER, "Numpad Enter");
  symNames.insert(DFKS_KP_EQUALS, "Numpad Equals");
  symNames.insert(DFKS_UP, "Up");
  symNames.insert(DFKS_DOWN, "Down");
  symNames.insert(DFKS_RIGHT, "Right");
  symNames.insert(DFKS_LEFT, "Left");
  symNames.insert(DFKS_INSERT, "Insert");
  symNames.insert(DFKS_HOME, "Home");
  symNames.insert(DFKS_END, "End");
  symNames.insert(DFKS_PAGEUP, "Page Up");
  symNames.insert(DFKS_PAGEDOWN, "Page Down");
  symNames.insert(DFKS_F1, "F1");
  symNames.insert(DFKS_F2, "F2");
  symNames.insert(DFKS_F3, "F3");
  symNames.insert(DFKS_F4, "F4");
  symNames.insert(DFKS_F5, "F5");
  symNames.insert(DFKS_F6, "F6");
  symNames.insert(DFKS_F7, "F7");
  symNames.insert(DFKS_F8, "F8");
  symNames.insert(DFKS_F9, "F9");
  symNames.insert(DFKS_F10, "F10");
  symNames.insert(DFKS_F11, "F11");
  symNames.insert(DFKS_F12, "F12");
  symNames.insert(DFKS_F13, "F13");
  symNames.insert(DFKS_F14, "F14");
  symNames.insert(DFKS_F15, "F15");
  symNames.insert(DFKS_NUMLOCKCLEAR, "Numlock");
  symNames.insert(DFKS_CAPSLOCK, "Capslock");
  symNames.insert(DFKS_SCROLLLOCK, "Scrollock");
  symNames.insert(DFKS_RSHIFT, "Rshift");
  symNames.insert(DFKS_LSHIFT, "Lshift");
  symNames.insert(DFKS_RCTRL, "Rctrl");
  symNames.insert(DFKS_LCTRL, "Lctrl");
  symNames.insert(DFKS_RALT, "Ralt");
  symNames.insert(DFKS_LALT, "Lalt");
#if 0
  symNames.insert(DFKS_RMETA, "Rmeta");
  symNames.insert(DFKS_LMETA, "Lmeta");
  symNames.insert(DFKS_LSUPER, "Lsuper");
  symNames.insert(DFKS_RSUPER, "Rsuper");
  symNames.insert(DFKS_MODE, "Mode");
  symNames.insert(DFKS_COMPOSE, "Compose");
  symNames.insert(DFKS_PRINTSCREEN, "Print");
  symNames.insert(DFKS_BREAK, "Break");
  symNames.insert(DFKS_EURO, "Euro");
#endif
  symNames.insert(DFKS_HELP, "Help");
  symNames.insert(DFKS_SYSREQ, "Sysreq");
  symNames.insert(DFKS_MENU, "Menu");
  symNames.insert(DFKS_POWER, "Power");
  symNames.insert(DFKS_UNDO, "Undo");
}
