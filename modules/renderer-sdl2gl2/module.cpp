...
void implementation::initialize() {
    ...
    gl_window = SDL_CreateWindow("Dwarf Fortress / sdl2gl2",
        SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED,
        window_w, window_h, SDL_WINDOW_OPENGL | SDL_WINDOW_RESIZABLE); // there's some weird SDL_WINDOW_SHOWN flag
